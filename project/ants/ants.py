...
"""Done by regular and Extra Credit problems & composition"""
"""Final version"""
"""@2019.10.17"""
...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if insect.name == 'Queen' and insect.is_queen:
                self.ant = insect
                return None
            # END Problem 13
...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        if self.direction == False and self.blocked() is False:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        moving_place = self.place
        i = 0
        while moving_place.entrance != beehive:
            if len(moving_place.bees) != 0 and self.min_range <= i <= self.max_range:
                return random_or_none(moving_place.bees)
            moving_place = moving_place.entrance
            i += 1
        return random_or_none(moving_place.bees)
        # END Problem 3 and 4
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        curr_bees = self.place.bees[:]
        Ant.reduce_armor(self, amount)
        if self.armor <= 0:
            for bee in curr_bees:
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if not other.is_container and self.contained_ant is None:
            return True
        # END Problem 9
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        if self.is_queen is False:
            ...
            while curr_place.exit is not None:  # """ That means find the ant behind the Queen_ant"""
                curr_place = curr_place.exit
                if curr_place.ant:
                    if hasattr(curr_place.ant, 'is_doubled') and curr_place.ant.is_doubled == False:
                        curr_place.ant.damage *= 2
                        curr_place.ant.is_doubled = True
                    if curr_place.ant.is_container and hasattr(curr_place.ant.contained_ant,
                                                               'is_doubled') and curr_place.ant.contained_ant.is_doubled == False:
                        curr_place.ant.contained_ant.damage *= 2
                        curr_place.ant.contained_ant.is_doubled = True
        # END Problem 13
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        Ant.reduce_armor(self, amount)
        if self.is_queen and self.armor <= 0:
            bees_win()
        # END Problem 13
...
def make_slow(action, bee):
    ...
    def make_slow_helper(colony):
        if colony.time % 2 == 0:
            return action(colony)
        else:
            return None

    return make_slow_helper
    # END Problem EC
...
def make_scare(action, bee):
    ...
    def make_scare_helper(colony):
        bee.direction = False
        return action(colony)

    return make_scare_helper
    # END Problem EC
...
def apply_effect(effect, bee, duration):
    ...
    def apply_effect_helper(colony):
        ...
        if duration > 0:
            duration -= 1
            return effect(previous_action, bee)(colony)
        else:
            bee.direction = True
            return previous_action(colony)
